...
describe('buildAnalyticsHeader', () => {
  ...
  it('assembles blocks in the expected order: CV (incl. def+off) → explosive → personnel → motion → quarter → route×cov → situational', () => {
    const header = buildAnalyticsHeader({
      ...
      defenders: [
        { jersey: '24', role: 'CB', matchupCount: 3, avgSeparationYards: 4, worstSeparationYards: 6, avgClosingYps: 2, avgOffenseSpeedYps: 8, trackIds: [], meanConfidence: 0.7, gameCount: 2, trust: 'medium' },
      ],
      offense: [
        { jersey: '88', role: 'WR', matchupCount: 3, avgMaxSpeedYps: 9, bestSeparationYards: 5, avgSeparationYards: 4, trackIds: [], meanConfidence: 0.7, gameCount: 2, trust: 'medium' },
      ],
      personnel: [
